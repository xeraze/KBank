# 🏦 KredaBank — Цифровий комфорт у світі Kherson, Ukraine

![KredaBank Logo](LOGO_MAIN.png)

**KredaBank** — це інноваційна платформа для управління ігровими активами та надання кредитних лімітів користувачам усередині екосистеми Kherson (Roblox). Проєкт поєднує в собі футуристичний дизайн, інтеграцію з Discord API та зручний інтерфейс для позичальників.
...
---
© 2026 KredaBank. Побудовано для спільноти Kherson, Ukraine.
